...
class DatabaseMCPClient:
    ...
    def __post_init__(self) -> None:
        if self.endpoint_url is None and settings.DB_MCP_URL is not None:
            self.endpoint_url = str(settings.DB_MCP_URL)
    ...
    def list_tables(self) -> dict[str, Any]:
        return self._call_tool_sync("list_tables", {})
    ...
    def _build_headers(self, endpoint: str) -> dict[str, str]:
        ...
        if parsed.hostname in {"localhost", "127.0.0.1"} and parsed.port == 3002:
